...
def run_tests(verbosity=2):
    ...
    if verbosity > 1:
        ...
        print(spacer)
        _run_tests(utilities_test_suite(verbosity), verbosity)
        print('\n'+spacer)
        print('Running algorithms Tests')
        print(spacer)
        _run_tests(algorithms_test_suite(verbosity), verbosity)
        print('\n'+spacer)
        ...
        print(spacer)
        _run_tests(sampling_test_suite(verbosity), verbosity)
        print('\n'+spacer)
        print('Running inversion.py Tests')
        print(spacer)
        _run_tests(inversion_test_suite(verbosity), verbosity)
        print('\n'+spacer)
        print('Running run.py Tests')
        print(spacer)
        _run_tests(run_test_suite(verbosity), verbosity)
        print('\n'+spacer)
        print('Running convert Tests')
        print(spacer)
        _run_tests(convert_test_suite(verbosity), verbosity)
        print('\n'+spacer)
        print('Running plot Tests')
        print(spacer)
        _run_tests(plot_test_suite(verbosity), verbosity)
        print('\n'+spacer)
